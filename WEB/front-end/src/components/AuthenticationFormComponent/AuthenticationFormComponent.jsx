...
const AuthenticationFormComponent = () => {
  ...
  return (
    <div className="w-screen h-screen bg-bgColor">
      <div className="max-w-2xl h-screen flex flex-col justify-center items-center bg-white shadow-signin pl-[4.5rem] pr-[4rem]">
        <div className="flex flex-col  space-y-15 w-full">
          <div
            className="absolute top-4 left-4 flex items-center font-medium text-blue-500 text-lg cursor-pointer"
            onClick={() => {
              router.push("/");
            }}
          >
          ...
          <div className="flex flex-col space-y-9">
            <h1 className="text-[5.5rem] font-semibold text-gray-800">
              Sign in
            </h1>
            <Label className="text-3xl text-gray-500 font-medium">
          ...
          <Form {...form}>
            ...
            >
                  ...
                  <FormItem className="space-y-6">
                    ...
                    <FormControl>
                      <Input
                        ...
                        className="bg-secondGray rounded-sm w-full h-13 !text-lg text-mainColor"
                        disabled={loading}
                      />
                    </FormControl>
              ...
              <Button
                type="submit"
                className="rounded-full w-41 h-13 bg-accentColor text-xl hover:bg-blue-500"
                disabled={loading}
              >
